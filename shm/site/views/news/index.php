...
<div class="news_content" id="news_content" data-ab-css-background>
    ...
    <div class="news_content_lists" data-request-url="<?php echo site_url('news/more/1/5'); ?>">
        <!--时间线-->
                        ...
                        <div class="timeline-content">
                            ...
                            <div class="new_info_content">
                                ...
                                <p class="news_shortInfo">
                                    近日，在中国信息化领域中具有高规格、大规模和深层影响力的表彰活动“2018第二届中国信息化创新发展大会”上……
                                </p>
                            </div>
                        </div>
                        <div class="bg_img">
                            <img class="forTestRgba active" id="images" src="/web/shmweb/assets/images/FFF-200x100.png">
                        </div>
                    </a>
                </li>
            --><?php /*endwhile; */?>
