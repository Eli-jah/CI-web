    ...
    <div class="container" id="body-main-login">
        ...
        <div class="boxed" id='login'>
                ...
                <div class="control-group">
                    <label class="checkbox">
                        <input type="checkbox" name="remember" value="1" id="remember"
                               class="select-it" <?php echo set_switch('remember', '1'); ?> >
            ...
            <div class="boxed-footer">
                ...
                <a id="btn-lostpass" href="#" class="pull-right"
                   style="padding-top:5px;"> <?php echo lang('password_lost') ?> </a>
            </div>
            </form>
            <p></p>
        ...
        <div style="text-align:center;color:#0088cc; font-size:14px; margin-top:421px; position:relative; z-index:1">
            <div class="login_links">
                <a href="http://www.sahereman.com/interact/website.html" target="_blank">网站建设</a><span>|</span><a
                    href="http://www.sahereman.com/interact/platform.html" target="_blank">技术开发</a><span>|</span><a
                    href="http://www.sahereman.com/digital/wechat.html" target="_blank">微信运营</a><span>|</span><a
                    href="http://www.sahereman.com/digital.html" target="_blank">数字营销</a>
            </div>
            <a href="http://www.sahereman.com/" target="_blank"> 青岛尚禾维曼网络 </a> 客服热线：400-800-5790
        </div>

        <!--
        <div style="text-align:center;color:#0088cc; font-size:14px; margin-top:400px;">
            <a href="http://www.sahereman.com/" target="_blank">
                < ?php echo lang('shm'); ?>
            </a>
            客服热线：< ?php echo lang('shm404'); ?>
        </div>
        -->
...
<div id="body-footer">
    <div class="container-fluid">
        <p class="muted credit"> Power by <a href="http://www.sahereman.com/"> &copy; <?php echo lang('shm') ?></a> .
        </p>
    </div>
</div>
