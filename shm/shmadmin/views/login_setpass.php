...
<div id="body-main">
    ...
    <div style="text-align:center;color:#0088cc; font-size:14px; margin-top:400px;"><a href="http://www.sahereman.com/"
                                                                                       target="_blank"> <?php echo lang('shm') ?> </a>
        客服热线：<?php echo lang('shm404'); ?> </div>
</div>
