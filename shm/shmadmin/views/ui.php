        ...
        <div class="navbar-inner">
            <div class="container">
                <ul class="nav-logo pull-left">
                    <li>
                        <a href="http://www.sahereman.com/" target="_blank"><img
                                src=" <?php echo static_file('shmlogo.png') ?>"></a>
                    </li>
                    <li>
                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i
                                class="fa fa-user"></i> <?php echo $this->session->userdata('nickname'); ?><b
                                class="caret"></b> </a>
                    ...
                    <!--
                    <li>
                        <a href="<?php // echo site_url('msgs'); ?>" style="border: 1px solid #ccc;border-width: 0 1px;padding-left: 5px;padding-right: 5px;">
                            <i class="icon-envelope"></i> <?php echo $this->config->item('msgs_num'); ?>
                        </a>
                    </li>
                    -->
                    <li>
