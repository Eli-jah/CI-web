<div class="btn-group"><a href="<?php echo site_url('feedback/index'); ?>" class="btn">
        <i class="fa fa-arrow-left"></i> <?php echo lang('back_list') ?> </a>
</div>
...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        ...
        <!--<div class="control-group uefull">
            <textarea id="answer"
                      name="answer"> <?php /*echo set_value('answer', htmlspecialchars_decode($it['answer'])); */?> </textarea>
        </div>-->
    </div>
