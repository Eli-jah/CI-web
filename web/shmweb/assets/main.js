...
$(function () {
    ...
    $(".header_menu_lists").on("mouseenter", function () {
        if (!$(this).hasClass("active")) {
            $(this).addClass("active");
            $(".local_name").addClass("active");
            $(".header_menu").addClass("active");
        } else {
            $("#lists_area").css("transition-delay", "0s");
        }
    });
    var x, y;
    $(document).mousemove(function (e) {
        ...
        if (x < x1 || x > x2 || y < y1 || y > y2) {
            ...
            $("#lists_area").css("transition-delay", "1.5s");
            $(".local_name").css("transition-delay", "1.5s");
            $(".header_menu").css("transition-delay", "1.5s");
        } else {
            $("#lists_area").css("transition-delay", "0s");
            $(".local_name").css("transition-delay", "0s");
            $(".header_menu").css("transition-delay", "0s");
            return false;
        }
    });
    // 移动端二级导航
